...
class GCN(nn.Layer):
    ...
    def __init__(self, in_features, out_features, graphname):
        ...
        if graphname == "MNIST":
            ...
            div = 1000
        d = np.random.rand(in_features, out_features) / div
...
class SDCN(nn.Layer):
    def __init__(self, in_features, clusters_num, graphname):
        """
...
def get_clusters_center(inputs, in_features, n_clusters, graphname):
    """
